...
CREATE TABLE Apprenti(Email VARCHAR(100) PRIMARY KEY, Programme VARCHAR(50), Majeure VARCHAR(100), Annee VARCHAR(50), Archiver BOOLEAN, EmailTuteur VARCHAR(100), FOREIGN KEY(Email) REFERENCES Utilisateur(Email), FOREIGN KEY(EmailTuteur) REFERENCES Tuteur(Email));
